...
const Enemies = (() => {
  ...
  const DEFS = {
    ...
    // Era 2 — Medieval
    witch:        { era:2, health: 360, speedTiles:1.8, townDamage: 20, spriteKey:'witch',            drawW: 40,  drawH: 40,  goldRange:[8,12]  },
    vampire:      { era:2, health: 520, speedTiles:2.8, townDamage: 35, spriteKey:'vampire',          drawW: 40,  drawH: 40,  goldRange:[8,12]  },
    ghost:        { era:2, health: 640, speedTiles:1.0, townDamage: 50, spriteKey:'ghost',            drawW: 40,  drawH: 40,  goldRange:[18,22] },

    // Era 3 — Pirate
    pirateSword:  { era:3, health:1050, speedTiles:1.8, townDamage: 40, spriteKey:'pirateSword',      drawW: 40,  drawH: 40,  goldRange:[8,12]  },
    pirateRifle:  { era:3, health: 750, speedTiles:1.0, townDamage: 30, spriteKey:'pirateRifle',      drawW: 40,  drawH: 40,  goldRange:[8,12]  },
    pirateBomb:   { era:3, health:1350, speedTiles:1.8, townDamage: 70, spriteKey:'pirateBomb',       drawW: 40,  drawH: 40,  goldRange:[18,22] },

    // Era 4 — WW2 Zombies
    gruntZombie:  { era:4, health: 720, speedTiles:1.8, townDamage: 45, spriteKey:'gruntZombie',      drawW: 40,  drawH: 40,  goldRange:[8,12]  },
    vombie:       { era:4, health: 880, speedTiles:1.0, townDamage: 65, spriteKey:'vombie',           drawW: 40,  drawH: 40,  goldRange:[18,22] },
    necroZombie:  { era:4, health:1200, speedTiles:1.0, townDamage: 90, spriteKey:'necroZombie',      drawW: 40,  drawH: 40,  goldRange:[18,22] },

    // Era 5 — Sci-Fi
    laserAlien:   { era:5, health:1120, speedTiles:2.8, townDamage: 70, spriteKey:'laserAlien',       drawW: 40,  drawH: 40,  goldRange:[8,12]  },
    fortniteBart: { era:5, health:1400, speedTiles:1.8, townDamage:100, spriteKey:'fortniteBart',     drawW: 40,  drawH: 40,  goldRange:[18,22] },
    flyingSaucer: { era:5, health: 880, speedTiles:4.0, townDamage: 55, spriteKey:'flyingSaucer',     drawW: 40,  drawH: 40,  goldRange:[8,12]  },
  };
