...
const Enemies = (() => {
  ...
  const DEFS = {
    ...
    // Era 2 — Medieval
    witch:        { era:2, health: 180, speedTiles:1.8, townDamage: 20, spriteKey:'witch',            drawW: 70,  drawH: 70,  goldRange:[8,12]  },
    vampire:      { era:2, health: 260, speedTiles:2.8, townDamage: 35, spriteKey:'vampire',          drawW: 70,  drawH: 70,  goldRange:[8,12]  },
    ghost:        { era:2, health: 320, speedTiles:1.0, townDamage: 50, spriteKey:'ghost',            drawW: 70,  drawH: 70,  goldRange:[18,22] },

    // Era 3 — Pirate
    pirateSword:  { era:3, health: 280, speedTiles:1.8, townDamage: 40, spriteKey:'pirateSword',      drawW: 70,  drawH: 70,  goldRange:[8,12]  },
    pirateRifle:  { era:3, health: 200, speedTiles:1.0, townDamage: 30, spriteKey:'pirateRifle',      drawW: 70,  drawH: 70,  goldRange:[8,12]  },
    pirateBomb:   { era:3, health: 360, speedTiles:1.8, townDamage: 70, spriteKey:'pirateBomb',       drawW: 70,  drawH: 70,  goldRange:[18,22] },

    // Era 4 — WW2 Zombies
    gruntZombie:  { era:4, health: 360, speedTiles:1.8, townDamage: 45, spriteKey:'gruntZombie',      drawW: 70,  drawH: 70,  goldRange:[8,12]  },
    vombie:       { era:4, health: 440, speedTiles:1.0, townDamage: 65, spriteKey:'vombie',           drawW: 70,  drawH: 70,  goldRange:[18,22] },
    necroZombie:  { era:4, health: 600, speedTiles:1.0, townDamage: 90, spriteKey:'necroZombie',      drawW: 70,  drawH: 70,  goldRange:[18,22] },

    // Era 5 — Sci-Fi
    laserAlien:   { era:5, health: 560, speedTiles:2.8, townDamage: 70, spriteKey:'laserAlien',       drawW: 70,  drawH: 70,  goldRange:[8,12]  },
    fortniteBart: { era:5, health: 700, speedTiles:1.8, townDamage:100, spriteKey:'fortniteBart',     drawW: 70,  drawH: 70,  goldRange:[18,22] },
    flyingSaucer: { era:5, health: 440, speedTiles:4.0, townDamage: 55, spriteKey:'flyingSaucer',     drawW: 70,  drawH: 70,  goldRange:[8,12]  },
  };
